...
- 📸 **参考图上传** - 支持上传最多3张参考图，AI将结合参考图和文字提示生成更精准的设计稿
...
1. **输入设计需求** - 描述您想要的UI界面
2. **上传参考图（可选）** - 上传最多3张参考图片，帮助AI更好地理解您的需求
3. **生成布局建议** - AI自动优化为4个不同风格的提示词
4. **选择设备类型** - iPhone / Android / PC
5. **选择生成模型** - 根据需要选择1-3个模型
6. **选择提示词** - 选择喜欢的提示词方案
7. **开始生成** - AI生成设计稿（每个模型生成4张）
8. **查看结果** - 预览、下载、收藏生成的设计稿
